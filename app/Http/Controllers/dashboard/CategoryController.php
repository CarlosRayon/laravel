...
class CategoryController extends Controller
{
    ...
    public function store(StoreCategoryPost $request)
    {
        ...
        Category::create($request->validated()); /* le paso los datos validados */
    ...
    {
        $category->update($request->validated()); /* le paso los datos validados */
        return back()->with('status', 'Categoría actualizado con éxito');
    }
